...
public class ExtendReportsBasicDemo {
	...
	public static void main(String[] args) {
        ...
        //"Google search Test One" is name of the test
        //"this is a test to validate google search functionality" is description of the test
		...
		test1.pass("Entered text in Searschbox");
		...
		driver.findElement(By.name("q")).sendKeys("automation");
		test2.pass("Entered text in Searschbox");
		...
		//***IMPORTANT: ****  calling flush  writes everything to the log file
		extent.flush();		
